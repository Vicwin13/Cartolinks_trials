...
const Footer = () => {
  return (
    <>
        <footer>
            <div className='flex px-6 items-center justify-between pb-2'>
            ...
            <div className='flex px-6 items-center flex-col sm:flex-row justify-between py-2 bg-[#111111] text-white'>
                <div className='flex items-center gap-2'>
                    <Image className='bg-white rounded-full' src={'\logo-waveform-svgrepo-com.svg'} alt={'logo'} width={50} height={45}/>
                    <span className='font-bold text-xl sm:text-3xl'>Krea AI</span>
                </div>
                <div className='flex items-center gap-4'>
                    <p className='font-bold text-xl sm:text-3xl'>curated by</p>
                    <div className='flex items-center gap-2 font-extrabold text-xl sm:text-3xl'>
